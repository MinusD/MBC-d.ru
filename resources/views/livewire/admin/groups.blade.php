    ...
    <div class="shadow-lg rounded-2xl p-4 bg-white dark:bg-gray-700 w-full">
        <table class="min-w-max w-full table-auto  border-gray-200 my-1 dark:bg-gray-700 dark:border-gray-600">
            ...
            <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal rounded-t-full ">
                <th class="table-cell md:hidden py-3 px-6 text-left rounded-tl-md ">ID</th>
                <th class="hidden md:table-cell py-3 px-6 text-left rounded-tl-md">ID</th>
                <th class="hidden md:table-cell py-3 px-6 text-left">Группа</th>
                <th class="hidden md:table-cell py-3 px-6 text-center">В группе</th>
                <th class="hidden md:table-cell py-3 px-6 text-center">Создана</th>
                ...
                <tr class="border-b border-gray-200 hover:bg-gray-100 dark:border-gray-500 dark:hover:bg-gray-800 {{ $key%2 ? 'bg-gray-50 dark:bg-gray-800' : '' }}">
                    ...
                    <td class="hidden md:table-cell py-3 px-6 text-center">
                        <div class="flex item-center justify-center">
                            <span>{{ number_format($group['counter'], 0, '', ' ') }}</span>
                        </div>
                    </td>
                    <td class="hidden md:table-cell py-3 px-6 text-center">
                        <div class="flex item-center justify-center">
