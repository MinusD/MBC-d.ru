...
<div>
    <x-modal.card title="Добавление пользователю бустера" blur wire:model.defer="info_modal">
        <div class="grid grid-cols-1 gap-4">
            <div class="text-md ">Код досутпа <code class="font-bold"> {{ $data->fs_code }}</code></div>
            <div class="text-md ">Пин код <code class="font-bold"> {{ $data->fs_pass }}</code></div>

            <x-input label="Новый пин код" wire:model.lazy="new_code"/>
        ...
        <x-slot name="footer">
            <div class="flex justify-between gap-x-4">
                ...
                <div class="flex">
                    ...
                    <x-button primary label="Сохранить" wire:click="saveNewCode" />
                </div>
            </div>
        </x-slot>
    </x-modal.card>
        ...
        <div class="relative z-20 flex flex-col justify-center h-full px-3 mx-auto flex-center">
            <div class="relative items-center pl-1 flex w-full lg:max-w-68 sm:pr-2 sm:ml-0">
                ...
                <div class="relative p-1 flex items-center justify-end w-1/4 ml-5 mr-4 sm:mr-0 sm:right-auto">
                    <x-button md primary wire:click="openModal">Настройки</x-button>
