...
{{--                    </div>--}}
                    ...
                    <div class="">
                        <div class="flex justify-between items-center rounded-md px-1 py-2 bg-gray-100 dark:bg-gray-600">
                        <div class="ml-3 ">
                            <span class="text-black font-semibold sm:text-lg md:text-lg 2xl:text-xl dark:text-gray-200">Отправить сообщение 1 </span>
                        </div>
                        <div class="w-1/4 items-center text-center flex">
