<div class="bg-gradient-to-br from-indigo-900 to-green-900 min-h-screen overflow-auto flex items-center justify-center">
        ...
        <div class=" flex items-center justify-center px-5 py-5">
            <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden"
                ...
                <div class="md:flex w-full">
                            ...
                            <div>
                                ...
                                >
                                    <div class="mb-6">
                                        ...
                                        <x-button lg outline secondary class="w-full mt-3" x-show="!student"
                                                  @click="student = true" label="Я Студент"
                                        />
                                ...
                                <div x-show="step === 2"
                                    ...
                                    {{--                                    Поиск для старосты--}}
                                    <div x-show="!student">
                                        <x-button md primary class="w-full mt-2" wire:click="search_group_by_headman">
                                            Найти
                                        </x-button>
                                        @if($group_search_error)
                                            <div class="text-red-600">Ошибка поиска группы</div>
                                        @elseif(isset($confirm_group['groupName']))
                                            <div class="p-4 mt-2 border rounded-2xl shadow-lg">
                                                ...
                                                <div class="text-md">Кафедра: <span
                                                        class="font-semibold">{{ $confirm_group['groupSuffix'] ?? 'не найдено' }}</span>
                                                </div>
                                            </div>
                                        @endif
                                    </div>
                    ...
                    {{--                            </div>--}}
                    {{--                            <div x-data="{ step: 1 }" class="transition">--}}
                    ...
                    {{--                                    </div>--}}
                    {{--                                </div>--}}
                    {{--                                <div x-show.transition="step === 'complete'" x-cloak>--}}
                    {{--                                    Всё готово--}}
                    {{--                                </div>--}}
                    ...
                    {{--                            <div class="flex -mx-3">--}}
                    {{--                                <div class="w-full px-3 mb-5">--}}
                    {{--                                    <x-button md danger class="w-full">На главную</x-button>--}}
    ...
    {{--            <div class="bg-gray-300">asdadasdas</div>--}}
    {{--            --}}
    {{--        </div>--}}
</div>
