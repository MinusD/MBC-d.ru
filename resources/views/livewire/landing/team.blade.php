    ...
    <div class="flex justify-center bg-gradient-to-br from-indigo-900 min-h-screen to-green-900">
        ...
        <section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-12">
            ...
            <div class="w-full flex items-center justify-center">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 flex items-center justify-center">
                    <div class="col-span-1 sm:col-span-2 w-full flex items-center justify-center">
                        <div
                            class="w-full sm:w-1/2 rounded-2xl p-12 flex flex-col justify-center items-center pt-4 bg-indigo-900 bg-opacity-40 shadow-2xl gap-5 py-5 rounded-lg ring-offset-blue-800 ring-cyan-700">
