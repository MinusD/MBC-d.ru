    ...
    <div class="flex justify-center bg-gradient-to-br from-indigo-900 min-h-screen to-green-900">
        ...
        <section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-12">
            ...
            <div class="w-full flex items-center justify-center">
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-6 flex">
                    <div
                    ...
                    {{--                <div class="w-full rounded-lg p-12 flex flex-col justify-center items-center border-2 pt-4 bg-indigo-900 bg-opacity-40 shadow-xl gap-5 py-5 rounded-lg ring-2 ring-offset-2 ring-offset-blue-800 ring-cyan-700">--}}
    ...
    <section class="" id="footer">
        <div class=" px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
            <nav class="flex flex-wrap justify-center -mx-5 -my-2">
                ...
                <div class="px-5 py-2">
                    <a href="{{ route('landing.about') }}" class="text-base leading-6 text-gray-500 hover:text-gray-900">
                        О нас
                    </a>
                </div>
                <div class="px-5 py-2">
                    <a href="{{ route('landing.contacts') }}" class="text-base leading-6 text-gray-500 hover:text-gray-900">
                        Контакты
                    </a>
                </div>
                <div class="px-5 py-2">
            ...
            <div class="flex justify-center mt-8 space-x-6">
                <a href="https://vk.com/maybecompany" target="_blank" class="text-gray-400 hover:text-gray-500">
                    ...
                    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="currentColor" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
