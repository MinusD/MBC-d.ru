        ...
        <div class="flex flex-col w-full pl-0 md:p-4 md:space-y-4">
            ...
            <header
                ...
                >
                    <div class="mb-2">
                        <a href="{{ route('headman.dashboard') }}"
                           class="flex flex-row items-center h-12 px-4 rounded-lg text-gray-500 bg-gray-100 {{ (request()->routeIs('headman.dashboard')) ? " bg-indigo-300 font-bold dark:text-gray-500 dark:bg-gray-100" : "bg-gray-50 dark:bg-gray-700 hover:dark:bg-gray-800 dark:text-white" }}">
